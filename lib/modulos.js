...
/**
 * Modulos sem implementacao nenhuma. NAO aparecem mais na tela (o dono pediu
 * para tirar o que nao usamos), e nunca tiveram interruptor.
 *
 * A lista continua existindo por um motivo especifico: `flagsPadraoSignup()`
 * grava estas chaves como `false`. Como `temModulo()` trata flag AUSENTE como
 * ligada, apagar o registro faria um modulo futuro nascer aberto no dia em que
 * ganhasse portao. Registrar o `false` e o que mantem a porta fechada.
 */
