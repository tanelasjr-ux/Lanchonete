...
export function createMensagemRepository(database) {
  ...
  return {
    ...
    /** Bulk insert usado pelo seed de demonstracao (route.js). Diferente de
     *  create(), recebe as mensagens ja completas (o seed monta id/created_at
     *  proprios para controlar a ordem cronologica da conversa demo). */
    createMany(entities) {
